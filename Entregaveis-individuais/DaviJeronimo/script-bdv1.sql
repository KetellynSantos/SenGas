...
CREATE TABLE empresa (
  ...
  dtFirma date, -- data de firmamento de contrato
...
INSERT INTO empresa (razaoSocial, nomeFantasia, cnpj, contratoAtivo) VALUES
    ...
    INSERT INTO filial (titulo, fkEndereco) VALUES
    ('filial1', 1),
    ('filial2', 2),
    ('filial3', 3);
...
INSERT INTO setor (titulo, fkFilial) VALUES
	('Captação', 1),
	('Extração', 2),
	('Armazenagem', 3);
...
FROM
	...
	JOIN setor AS s ON f.idFilial = s.fkFilial
